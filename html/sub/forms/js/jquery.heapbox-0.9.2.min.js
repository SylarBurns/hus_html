...
(function(e, t, n, r) {
    ...
    o.prototype = {
        ...
        _setData: function(t) {
            ...
            var i = false;
            if (this.isSourceElementSelect) this._refreshSourceSelectbox(r);
        ...
        _optionsToJson: function() {
            ...
            e(this.element).find("option").each(function() {
                t.push({
                    ...
                    selected: e(this).is(":selected") ? "selected" : ""
                })
            });
        ...
        _handlerClicked: function(e) {
            if (this.instance.state) {
                ...
                if (!e) this._closeOthers();
                else this._openheap()
            }
        },
        _heapChanged: function(t, n, r) {
            if (!r) this._closeheap(true, function() {}, function() {});
        ...
        _closeheap: function(t, n, r) {
            ...
            if (heapEl.is(":animated") && !t) return false;
        ...
        _callbackManager: function(e, t, n) {
            if (!this.callbackManager[t]) this.callbackManager[t] = 0;
            if (e == "change") {
